...
class AudioDecoder {
  static const platform = MethodChannel("mighty_plug/decoder");
  int size = 0;
  ...
  void decode(VoidCallback onStart, bool Function() onProgress,
    ...
    debugPrint("sample step $sampleStep");
    ...
    debugPrint('decode executed in ${stopwatch.elapsed}');

...
class PlugProPreset extends Preset {
  ...
  PlugProPreset(
    ...
    amplifierList.addAll([
      ...
      BassMate(),
      Tweedy(),
      if (showHiddenAmps) TwinRvb(),
      HiWire(),
      CaliCrunch(),
      if (showHiddenAmps) ClassA15(),
      ClassA30(),
      Plexi100(),
      Plexi45(),
      Brit800(),
      ...
      DualRect(),
      DIEVH4(),
      if (showHiddenAmps) VibroKing(),
      if (showHiddenAmps) Budda(),
      MrZ38(),
      SuperRvb(),
      if (showHiddenAmps) BritBlues(),
      if (showHiddenAmps) MatchD30(),
      if (showHiddenAmps) Brit2000(),
      if (showHiddenAmps) UberHiGain(),
      AGL(),
      MLD(),
      OptimaAir(),
      Stageman(),
